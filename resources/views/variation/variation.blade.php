        ...
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><a href="{{ route('variation.remove',$color->id) }}" class="shadow btn btn-danger btn-xs sharp"><i class="fa fa-trash"></i></a></td>
                </tr>
...
<div class="col-lg-4">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('variation.post') }}" method="post">
                @csrf
                <div class="mb-3">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td> <a href="" class="shadow btn btn-danger btn-xs sharp"><i class="fa fa-trash"></i></a></td>
                                </tr>
