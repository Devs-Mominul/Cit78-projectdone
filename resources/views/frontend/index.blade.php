    ...
    <div class="container container-fluid-sm">
        <div class="hero-slider">
            <div class="hero-slider-item">
                <div class="slider-bg">
                    <img src="{{asset('frontend')}}/assets/images/slider/sliderbanner.jpg" alt="">
                </div>
    ...
    <div class="container">
        ...
        <div class="featured-categorie-slider owl-carousel">
           ...
           <div class="featured-item">
            ...
            <div class="mt-5 text">
                <h2><a href="{{ route('category.product',$category->id) }}">{{ $category->category_name }}</a></h2>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12">
                <div class="banner-two-wrap" width='100%'>
                    <div class="text">
                        <h2>New Year Sale</h2>
                        <h4>Up To 70% Off</h4>
                        <a class="theme-btn-s2" href="#">Shop Now</a>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                <div class="product-item">
                    <div class="image">
                        <img height="300px" src="{{ asset('uploads/product/preview') }}/{{ $product->preview }}" alt="">
                        <div class="tag new">New</div>
                    </div>
                    <div class="text">
                        <h2><a href="{{ route('product_details',$product->slug) }}">{{ $product->product_name }}</a></h2>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="text">
                        ...
                        <a class="upcoming-btn" href="#">Shop Now</a>
                    </div>
                </div>
            </div>
...
<section class="themart-trendingproduct-section section-padding">
    <div class="container">
        ...
        <div class="trendin-slider owl-carousel">
           ...
           <div class="product-item">
            <div class="image">
                <img height="350px" src="{{ asset('uploads/product/preview') }}/{{ $product->preview }}" alt="">
                <div class="tag new">New</div>
            </div>
            <div class="text">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="highlight-wrap">
                    ...
                    <div class="product-card">
                        <div class="card-image">
                            <div class="image">
                                <img height="150px" src="{{ asset('uploads/product/preview') }}/{{ $product->preview }}" alt="">
                            </div>
                        </div>
                        <div class="content">
