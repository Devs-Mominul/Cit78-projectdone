                ...
                <div class="shop-filter-wrap">
                    ...
                    <div class="filter-item">
                        <div class="shop-filter-item category-widget">
                            ...
                            <li><a href="#">{{ $category->category_name }}<span>({{ App\Models\Subcategory::where('category_id',$category->id)->count() }})</span></a></li>
                            ...
                            <ul>
                                <li>
                                    <div class="product-card">
                                        <div class="card-image">
                                            <div class="image">
                                                <img src="{{asset('frontend')}}/assets/images/new-product/1.png" alt="">
                                            </div>
                                        </div>
                                        <div class="content">
                                ...
                                <li>
                                    <div class="product-card">
                                        <div class="card-image">
                                            <div class="image">
                                                <img src="{{asset('frontend')}}/assets/images/new-product/2.png" alt="">
                                            </div>
                                        </div>
                                        <div class="content">
                                ...
                                <li>
                                    <div class="product-card">
                                        <div class="card-image">
                                            <div class="image">
                                                <img src="{{asset('frontend')}}/assets/images/new-product/3.png" alt="">
                                            </div>
                                        </div>
                                        <div class="content">
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="product-item">
                            <div class="image">
                                <img height="250px" src="{{ asset('uploads/product/preview') }}/{{ $product->preview }}" alt="">
