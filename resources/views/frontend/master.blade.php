...
<head>
    ...
    <title>Design&Developed Mominul Haque</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="contact-info">
                                <ul>
                                    <li><a href="tel:869968236"><span>Need help? Call Us:</span>+8801963409912</a></li>
                                    <li>
                                        <div class="dropdown">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2">
                            <div class="navbar-header">
                                <a class="navbar-brand" href=""><h2>TrCorporation<br/>GroupBd</h2>
                                        </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="middle-right">
                                <ul>
                                    <li><a href=""><i class="fi flaticon-right-and-left"></i><span>Compare</span></a>
                                    </li>
                                    @auth('customer')
                                    ...
                                    <li>
                                        <div class="header-wishlist-form-wrapper">
                                            ...
                                            <div class="mini-wislist-content">
                                                <button class="mini-cart-close"><i class="ti-close"></i><span>0</span></button>
                                                ...
                                                <div class="clearfix mini-cart-action">
                                                    <div class="mini-btn">
                                                        <a href="" class="view-cart-btn">View Wishlist</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mini-cart-content">
                                               ...
                                               <div class="mini-cart-items">
                                                ...
                                                <div class="clearfix mini-cart-item">
                                                    ...
                                                    <div class="mini-cart-item-image">
                                                        <a href="#"><img src="{{ asset('uploads/product/preview/') }}/{{ $card->rel_to_product->preview }}" alt></a>
                                                    </div>
                                                    <div class="mini-cart-item-des">
                                                ...
                                                <div class="clearfix mini-cart-action">
                                                    ...
                                                    <span class="mt-5 mini-checkout-price">Subtotal:
                                                        <span>${{ $sub }}</span></span>
                                                    <div class="mini-btn">
                        ...
                        <div class="row align-items-center">
                                        ...
                                        <ul id="metis-menu">
                                            ...
                                            <li class="header-catagory-item">
                                                ...
                                                <ul class="header-catagory-single">
                                                    ...
                                                    <li><a href="{{ route('categorys.product',$subcategory->id) }}">{{ $subcategory->subcategory_name }}</a></li>
                            ...
                            <div class="col-lg-2 col-md-1 col-1">
                                <div class="header-right">
                                    <a href="" class="recent-btn"><i class="fi flaticon-refresh"></i>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="widget instagram">
                                ...
                                <ul class="d-flex">
                                    <li><a href="#"><img src="{{asset('frontend')}}/assets/images/instragram/1.jpg"
                                                alt=""></a></li>
                                    <li><a href="#"><img src="{{asset('frontend')}}/assets/images/instragram/2.jpg"
                                                alt=""></a></li>
                                    <li><a href="#"><img src="{{asset('frontend')}}/assets/images/instragram/4.jpg"
                                                alt=""></a></li>
                                    <li><a href="#"><img src="{{asset('frontend')}}/assets/images/instragram/3.jpg"
                                                alt=""></a></li>
                                    <li><a href="#"><img src="{{asset('frontend')}}/assets/images/instragram/4.jpg"
                                                alt=""></a></li>
                                    <li><a href="#"><img src="{{asset('frontend')}}/assets/images/instragram/1.jpg"
